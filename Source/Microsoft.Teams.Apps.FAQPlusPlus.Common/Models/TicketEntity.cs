...
namespace Microsoft.Teams.Apps.FAQPlusPlus.Common.Models
{
    ...
    public class TicketEntity : TableEntity
    {
        ...
        /// <summary>
        /// Gets or sets language code for the ticket.
        /// </summary>
        [IsSortable]
        [IsFilterable]
        ...
        /// <summary>
        /// Gets or sets the user principal name of the assigned SME currently working on the ticket.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the question returned to the user from the knowledgebase.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the answer given by SME to user.
        /// </summary>
        [JsonProperty("AnswerBySME")]
        public string AnswerBySME { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether gets or sets if the ticket is deleted.
        /// </summary>
