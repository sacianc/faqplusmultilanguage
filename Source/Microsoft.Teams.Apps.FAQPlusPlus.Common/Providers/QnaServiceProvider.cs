...
namespace Microsoft.Teams.Apps.FAQPlusPlus.Common.Providers
{
    ...
    public class QnaServiceProvider : IQnaServiceProvider
    {
        ...
        public QnaServiceProvider(string languageCode, IConfigurationDataProvider configurationProvider, IOptionsMonitor<QnAMakerSettings> optionsAccessor, IQnAMakerClient qnaMakerClient, IQnAMakerRuntimeClient qnaMakerRuntimeClient)
        {
        ...
        /// <summary>
        /// This method is used to get applicable language code for the Qna Service provider.
        /// </summary>
        /// <returns>Language code.</returns>
        public string GetApplicableLanguageCode()
        {
        ...
        public async Task<Operation> AddQnaAsync(string knowledgeBaseId, string question, string combinedDescription, string createdBy, string conversationId, string activityReferenceId)
        {
            // Update knowledgebase.
            return await this.qnaMakerClient.Knowledgebase.UpdateAsync(knowledgeBaseId, new UpdateKbOperationDTO
            {
        ...
        public async Task UpdateQnaAsync(string knowledgeBaseId, int questionId, string answer, string updatedBy, string updatedQuestion, string question)
        {
        ...
        /// <param name="questionId">Question id.</param>
        /// <returns>Perfomed action task.</returns>
        public async Task DeleteQnaAsync(string knowledgeBaseId, int questionId)
        {
        ...
        public async Task<QnASearchResultList> GenerateAnswerAsync(string question, bool isTestKnowledgeBase)
        {
            ...
            var languageKBConfigurationEntity = await this.configurationProvider.GetSavedLanguageKBConfigurationEntityAsync(this.languageCode);

            QnASearchResultList qnaSearchResult = await this.qnaMakerRuntimeClient.Runtime.GenerateAnswerAsync(languageKBConfigurationEntity.KnowledgeBaseId, new QueryDTO()
            {
