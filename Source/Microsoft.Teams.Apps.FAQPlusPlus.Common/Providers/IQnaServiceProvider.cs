...
namespace Microsoft.Teams.Apps.FAQPlusPlus.Common.Providers
{
    ...
    public interface IQnaServiceProvider
    {
        ...
        string GetApplicableLanguageCode();
        ...
        Task<Operation> AddQnaAsync(string knowledgeBaseId, string question, string combinedDescription, string createdBy, string conversationId, string activityReferenceId);
        ...
        Task DeleteQnaAsync(string knowledgeBaseId, int questionId);
        ...
        Task UpdateQnaAsync(string knowledgeBaseId, int questionId, string answer, string updatedBy, string updatedQuestion, string question);
        ...
        /// <summary>
        ///  Checks whethe knowledgebase is valid or not.
        /// </summary>
        /// <param name="knowledgeBaseId">Knowledgebase Id</param>
