...
namespace Microsoft.Teams.Apps.FAQPlusPlus.Common
{
    ...
    public static class Constants
    {
        ...
        /// </summary>
        public const string AskAnExpert = "ask expert";
        ...
        /// <summary>
        /// Text that triggers english language.
        /// </summary>
        public const string EnglishLanguage = "English";

        /// <summary>
        /// Text that triggers spanish language.
        /// </summary>
        public const string SpanishLanguage = "Español";

        /// <summary>
        /// Text that triggers portuguese language.
        /// </summary>
        public const string PortugueseLanguage = "Portugués";

        /// <summary>
        /// Text that triggers language change card.
        /// </summary>
        public const string ChangeLanguage = "change language";

        /// <summary>
        /// Text that redirects to My Question tab.
        /// </summary>
        public const string MyQuestions = "my questions";

        /// <summary>
        /// Represents partition key for LanguageKBConfiguration in ConfigurationInfo table in Azure table storage.
        /// </summary>
        public const string LanguageKBConfigurationPartitionKey = "LanguageKBConfiguration";

        /// <summary>
        /// Table name where user language preference from bot will be saved.
        /// </summary>
        public const string UserLanguagePreferenceTableName = "UserLanguagePreference";
    }
}
