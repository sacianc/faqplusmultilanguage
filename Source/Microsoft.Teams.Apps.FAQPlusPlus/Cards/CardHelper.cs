...
namespace Microsoft.Teams.Apps.FAQPlusPlus.Cards
{
    ...
    public static class CardHelper
    {
        ...
        /// <summary>
        /// Maximum length of the ticket Id.
        /// </summary>
        public const int TicketIdMaxDisplayLength = 50;
        ...
        {
            if (ticket?.Status == (int)TicketState.Answered)
            {
                return Strings.AnsweredUserNotificationStatus;
            }
            else
            {
                return Strings.UnAnsweredUserNotificationStatus;
            }
        }
