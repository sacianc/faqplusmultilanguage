...
const errorPage: React.FunctionComponent<RouteComponentProps> = props => {
    ...
    const generalErrorMessage = "Ooops! An unexpected error seems to have occurred. Why not try refreshing your page? Or you can contact your administrator if the problem persists.";
