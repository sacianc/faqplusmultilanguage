...
export class AxiosJWTDecorator {
    ...
    private async setupAuthorizationHeader(
        ...
        return new Promise<AxiosRequestConfig>((resolve, reject) => {
            ...
            let applicationIdURI = localStorage.getItem('applicationIdURIValueInLocalStorage');
                ...
                microsoftTeams.getContext(context => {
                    ...
                    if (applicationIdURI === "") {
                        getAuthenticationMetadata(windowLocationOriginDomain, loginHint).then(result => {
                            ...
                            resultdata = result.data.split("ApplicationIdURI=");
                            applicationIdURI = resultdata[1];
                            localStorage.setItem('applicationIdURIValueInLocalStorage', applicationIdURI);
                        });
                    }
                });
            }
            const authTokenRequest = {
                ...
                resources: [applicationIdURI.toString()]
            };
