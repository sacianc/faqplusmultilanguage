...
namespace Microsoft.Teams.Apps.FAQPlusPlus.Configuration {
    ...
    public class Strings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Provide all the details and then click on Ok to add or Edit to modify.
        /// </summary>
        public static string ToolTipHoverMessage {
            get {
                return ResourceManager.GetString("ToolTipHoverMessage", resourceCulture);
            }
        }
