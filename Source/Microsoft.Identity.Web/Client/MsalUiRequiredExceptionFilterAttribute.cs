// <copyright file="MsalUiRequiredExceptionFilterAttribute.cs" company="Microsoft">
...
namespace Microsoft.Identity.Web.Client
{
    ...
    public class MsalUiRequiredExceptionFilterAttribute : ExceptionFilterAttribute
    {
        ...
        public override void OnException(ExceptionContext context)
        {
            ...
            if (msalUiRequiredException != null)
            {
                if (this.CanBeSolvedByReSignInUser(msalUiRequiredException))
                {
                    var properties =
                        this.BuildAuthenticationPropertiesForIncrementalConsent(this.Scopes, msalUiRequiredException, context.HttpContext);
            ...
            string[] scopes, MsalUiRequiredException ex, HttpContext context)
        {
            ...
            // Attempts to set the loginHint to avoid the logged-in user to be presented with an account selection dialog
